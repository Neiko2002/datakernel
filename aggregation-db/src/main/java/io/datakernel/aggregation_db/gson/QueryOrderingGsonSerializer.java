...
public final class QueryOrderingGsonSerializer implements JsonSerializer<AggregationQuery.QueryOrdering>,
		JsonDeserializer<AggregationQuery.QueryOrdering> {
	@Override
	public AggregationQuery.QueryOrdering deserialize(JsonElement json, Type type, JsonDeserializationContext ctx)
		...
		if (direction.equals("asc"))
			return AggregationQuery.QueryOrdering.asc(orderingField);

		if (direction.equals("desc"))
			return AggregationQuery.QueryOrdering.desc(orderingField);

		throw new QueryException("Unknown 'direction' property value in sort object. Should be either 'asc' or 'desc'");
	}

	@Override
	public JsonElement serialize(AggregationQuery.QueryOrdering ordering, Type type, JsonSerializationContext ctx) {
