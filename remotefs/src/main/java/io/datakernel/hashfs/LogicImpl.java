...
final class LogicImpl implements Logic {
	...
	public static LogicImpl newInstance(ServerInfo myId, Set<ServerInfo> bootstrap) {
		return build(myId, bootstrap).build();
	}

	public static Builder build(ServerInfo myId, Set<ServerInfo> bootstrap) {
